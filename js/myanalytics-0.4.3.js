...
======================================================================
myAnalytics v0.4.3
myanalytics-0.4.3.js
Includes support for:
-Process Time (not guaranteed to work)
-Conversion Rate (not guaranteed to work)
-Basic Analytics
By: Sergio García [https://github.com/secasema/myAnalytics]

Note: EXPA endpoints are being changes, and thus this script is not
meant to be a definitive solution anymore (it was never meant to be so,
as a matter of fact). This file structure will be deprecated very soon.
...
function reqprocess(access_token,ey,selected,resolve,reject){
	...
	var url = "https://analytics.api.aiesec.org/v2/applications/analyze.json";
	var params = {
